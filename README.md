...
Personal Codex skills maintained by Ana.
...
Copy the complete skill directory into your Codex skills directory:

```sh
cp -R <skill-name> "$CODEX_HOME/skills/"
```

Restart Codex after installing or updating a skill so it reloads the skill catalog.
